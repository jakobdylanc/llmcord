...
| **max_token_output** | The maximum number of tokens allowed in the model's response. When exceeded, the response will be truncated and a warning will be displayed. (Default: `1000`) |
